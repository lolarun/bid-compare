...
DOCS = {
    "上海浦东": ("docs/test1/prj1", "quote_cable_pudong"),
    "亨通":     ("docs/test1/prj1", "quote_cable_hengtong"),
    "宏胜":     ("docs/test1/prj1", "quote_cable_hongsheng"),
    "远东":     ("docs/test1/prj1", "quote_cable_yuandong"),
    "凯硕新正": ("docs/test",       "quote_kaishuo"),
    "上海绵存": ("docs/test",       "quote_miancun"),
    "泰科龙":   ("docs/test",       "quote_taikelong"),
}
