...
基准来自 tests/fixtures/documents/tender_list/金桥地体上盖招标文件.xlsx（客户提供、已人工核对）。
...
PDF = REPO / "tests/fixtures/documents/tender/金桥地体上盖招标文件.pdf"
XLSX = REPO / "tests/fixtures/documents/tender_list/金桥地体上盖招标文件.xlsx"
