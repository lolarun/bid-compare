...
# slug → (文件名关键字, 所在目录)
DOCS = {
    "quote_cable_pudong": ("上海浦东", "docs/test1/prj1"),
    "quote_cable_hengtong": ("亨通", "docs/test1/prj1"),
    "quote_cable_hongsheng": ("宏胜", "docs/test1/prj1"),
    "quote_cable_yuandong": ("远东", "docs/test1/prj1"),
}
...
def derive_expected(snap: dict) -> dict:
    ...
    """
    from apps.api.intelligence.vl_direct import build_draft
    import collections
