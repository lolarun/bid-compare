...
DOCS = {
    ...
    "亨通": ("tests/fixtures/documents", 20966959.43),
    "宏胜": ("tests/fixtures/documents", 20597048.33),
    "远东": ("tests/fixtures/documents", 20014715.08),
    "凯硕新正": ("tests/fixtures/documents", 932154.0),
    "上海绵存": ("tests/fixtures/documents", 1667051.0),
    "泰科龙": ("tests/fixtures/documents", 1067616.41),
}
