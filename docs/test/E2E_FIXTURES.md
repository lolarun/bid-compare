...
本文件记录"当前资料完整交付"这条 E2E 的**唯一基准测试集**。所有识别准确率、质量门、对齐与导出的验收都以这套文档为准。规范副本位于 `docs/test/`（`docs/项目资料/初始资料/` 下有重复原件，仅作来源备份，不用于测试）。
...
|---|---|---|---|---|
| 招标文件 | 金桥地体上盖招标文件.pdf | `docs/test/金桥地体上盖招标文件.pdf` | 18 页 / 0.30 MB | ✅ 见下方 Excel 清单 |
| 采购清单 | 金桥地体上盖招标文件.xlsx | `docs/test/金桥地体上盖招标文件.xlsx` | — | ✅ **本身即标准答案**；用户已核对，与招标 PDF ~100% 一致 |
| 投标-1 | 上海绵存投标文件.pdf | `docs/test/上海绵存投标文件.pdf` | **31 页** / 17.50 MB | ⏳ 待转换为 Excel |
| 投标-2 | 泰科龙投标文件.pdf | `docs/test/泰科龙投标文件.pdf` | **53 页** / 35.19 MB | ⏳ 待转换为 Excel（扫描+转置表，最难）|
| 投标-3 | 凯硕新正投标文件.pdf | `docs/test/凯硕新正投标文件.pdf` | 19 页 / 14.88 MB | ⏳ 待转换为 Excel |
...
- [ ] 上海绵存投标文件 → Excel
- [x] 泰科龙投标文件 → Excel ✅ `docs/test/泰科龙投标清单.xlsx`（89行，声明总价 1,067,616.41，用户逐行核对）
- [ ] 凯硕新正投标文件 → Excel
